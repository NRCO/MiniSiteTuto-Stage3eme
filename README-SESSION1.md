# Session 1 : Les bases du HTML et CSS

**Durée : 2 jours (Jour 1 et Jour 2)**

Bienvenue ! Tu vas apprendre à créer ton premier site web : un journal en ligne sur les jeux vidéo et la technologie.

> Quand tu auras terminé cette session, passe à la **Session 2** dans le dossier `session2/` !
...
Tu as terminé la Session 1 ? Bravo !

Passe à la **Session 2** pour apprendre :
- **Flexbox** : la mise en page moderne
- **Tailwind CSS** : un framework CSS ultra-populaire
- **JavaScript** : rendre ton site interactif !

Ouvre le fichier `session2/README-SESSION2.md` pour continuer.

---

*Session 1 - Projet stage de découverte*
